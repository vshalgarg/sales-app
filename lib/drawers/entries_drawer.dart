      ...
      child: Padding(
        ...
        child: ListView(
          children: [
            SizedBox(height: 50),
            CustomListTile(
              onTap: () {Navigator.push(context, MaterialPageRoute(builder:(context)=>EntriesBillEntry()));
              },
              title: "Bill Entry",
            ...
            CustomListTile(
              onTap: () {Navigator.push(context, MaterialPageRoute(builder:(context)=> CreditEntry()));},
              title: "Credit Entry",
              textStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.w400),
