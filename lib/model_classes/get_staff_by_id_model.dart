...
/// phone : "87654321"
/// joiningDate : "2017-10-10"

class GetStaffByIdModel {
  GetStaffByIdModel({
      num? staffId, 
      String? staffName, 
      String? phone, 
  ...
  GetStaffByIdModel.fromJson(dynamic json) {
  ...
  String? _phone;
  String? _joiningDate;
GetStaffByIdModel copyWith({  num? staffId,
  String? staffName,
  String? phone,
  String? joiningDate,
}) => GetStaffByIdModel(  staffId: staffId ?? _staffId,
