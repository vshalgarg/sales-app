...
const Purchase = () => {
  ...
  const handleChangePage = async (page) => {
    if (page < 1 || page > totalPages || page === currentPage || loading)
      return;
    await handlePurchaseDetailHistory(page);
  };
  ...
  const handlePurchaseDetailHistory = async (page = 1) => {
      ...
      <div className="flex flex-col h-full overflow-y-auto">
        ...
        <div className="bg-white w-full h-[30vh] flex flex-col border p-4 mt-2 rounded border-gray-300">
          <div className="border-b border-gray-300 shrink-0">
            ...
            <p className="mb-2">
              Select criteria to refine your purchase history view
            </p>
          </div>
            ...
            <div>
              ...
              <div className="mt-5 flex justify-end space-x-3">
                ...
                <button
                  ...
                  onClick={() => handlePurchaseDetailHistory(1)}
                  disabled={loading}
                >
                  Apply Filters
                </button>
        ...
        <PurchaseHistory
          initialPurchaseHistory={purchaseHistoryData}
