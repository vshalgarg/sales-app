        ...
        <div className="px-3 py-2 md:p-6 border-b border-gray-300 dark:border-zinc-700 sticky top-0 bg-white dark:bg-gray-900 z-10 flex items-center gap-3">
          ...
          <div className="flex items-center justify-between w-full min-w-0">
            <h2 className="text-lg md:text-xl font-semibold truncate">
              {isView ? "Customer Details" : "Update Customer"}
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {isView ? (
                <>
                  ...
                  <DetailField label="MSME">{customer.msme || "-"}</DetailField>
                  <DetailField label="Referenced By">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {isView ? (
                <>
                  ...
                  <DetailField label="State">{customer.state || "-"}</DetailField>
                  <DetailField label="City">{customer.city || "-"}</DetailField>
                  <DetailField label="Pin Code">{customer.pinCode || "-"}</DetailField>
                </>
              ) : (
                <>
                  <CustomTextField
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {isView ? (
                <div>
                  ...
                  >
                    {Array.isArray(customer.preferredTransports) &&
                    customer.preferredTransports.length > 0 ? (
              ...
              {isView ? (
                <DetailField label="Remark">{customer.remark || "-"}</DetailField>
              ) : (
                <CustomTextField
                  name="remark"
                  value={form.remark || ""}
